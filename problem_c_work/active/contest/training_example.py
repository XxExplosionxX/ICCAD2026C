...
Shows how to train a neural network using the differentiable contest cost.
Run:
    python problem_c_work/active/contest/training_example.py --data-path <repo-root>
"""
...
ACTIVE_ROOT = THIS_DIR.parent
WORK_ROOT = ACTIVE_ROOT.parent
...
def main():
    ...
    print("")
    print("Final evaluation: python problem_c_work/active/contest/iccad2026_evaluate.py --evaluate your_optimizer.py")
    print("="*70)
