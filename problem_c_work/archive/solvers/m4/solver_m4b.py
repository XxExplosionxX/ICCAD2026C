#!/usr/bin/env python3
"""
M4b solver for ICCAD 2026 Problem C.

This is a replan of M4 after the first attempt missed the runtime gate:
- keeps the stable M2 constructive flow
- compares only two exact-scored full-layout branches
- prefers lower runtime while preserving exact branch selection
"""
