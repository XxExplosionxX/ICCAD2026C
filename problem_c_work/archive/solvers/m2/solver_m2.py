#!/usr/bin/env python3
"""
M2 solver for ICCAD 2026 Problem C.

This is an isolated evolution of M1:
- preserves exact area legality
- adds discrete aspect-ratio search
- uses connectivity-aware anchor generation
- runs bounded local refinement with deterministic budgets
"""
